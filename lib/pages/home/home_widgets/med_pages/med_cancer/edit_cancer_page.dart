...
class TelaEditarCadastroCancer extends StatefulWidget {
  @override
  State<TelaEditarCadastroCancer> createState() => _TelaEditarCadastroCancer();
}

class _TelaEditarCadastroCancer extends State<TelaEditarCadastroCancer> {
                ...
                Container(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      ...
                      if (id == null) {
                        db.collection('remedioCancer').add({
                          "nome": txtNome.text,
