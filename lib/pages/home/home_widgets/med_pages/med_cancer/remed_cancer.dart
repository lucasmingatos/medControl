...
class TelaCadastroCancer extends StatefulWidget {
  @override
  State<TelaCadastroCancer> createState() => _TelaCadastroCancer();
}

class _TelaCadastroCancer extends State<TelaCadastroCancer> {
