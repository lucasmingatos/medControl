...
class TelaEditarCadastroDiabetes extends StatefulWidget {
  @override
  State<TelaEditarCadastroDiabetes> createState() =>
      _TelaEditarCadastroDiabetesState();
}

class _TelaEditarCadastroDiabetesState
    extends State<TelaEditarCadastroDiabetes> {
                ...
                Container(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      ...
                      if (id == null) {
                        db.collection('remedioDiabetes').add({
                          "nome": txtNome.text,
